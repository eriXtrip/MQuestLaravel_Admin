            ...
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    <div class="mb-3 text-danger">
                        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" viewBox="0 0 16 16" class="bi bi-exclamation-triangle-fill text-success">
                    ...
                    <div class="d-flex gap-2 justify-content-center">
                        ...
                        <button class="btn btn-success rounded-pill px-4 py-2" type="button" id="confirmPublishBtn">
                            Publish Lesson
                        </button>
                    </div>
                </div>
