   ...
   function createSectionCard(section) {
        ...
        card.innerHTML = `
            ...
            <div class="section-created d-flex align-items-center justify-content-between">
                ...
                <button class="delete-section-btn ms-2 border-none text-danger" data-section-id="${section.section_id}" title="Delete section">
                    <svg class="bi bi-trash3 ms-2" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" style="font-family: Poppins, sans-serif;">
