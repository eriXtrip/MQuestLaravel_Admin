...
<body>
                                ...
                                <div class="col-6 col-lg-3">
                                    <div class="card stat-card-2">
                                        <div class="text-center card-body-2">
                                            ...
                                            <h5 class="fw-bold card-title-2" id="lessonCount"></h5>
        ...
        <div class="dialog-content">
            ...
            <div class="d-flex flex-column gap-2">
                ...
                <button class="btn btn-outline-primary" id="startBlankBtn">
                    <svg class="bi bi-file-earmark-plus" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
    ...
    <script>
        const allLessons = @json($allLessons);

        console.log('All Lessons:', allLessons);
        console.log('All Contents:', @json($allContents));

        // Set the count inside the <h5>
