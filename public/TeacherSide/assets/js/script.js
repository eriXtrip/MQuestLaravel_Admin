   ...
   function createSectionCard(section) {
        ...
        card.innerHTML = `
            ...
            <div class="section-created d-flex align-items-center justify-content-between">
                ...
                <button class="delete-section-btn ms-2" data-section-id="${section.section_id}" title="Delete section">
                    <svg class="bi bi-trash text-danger" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
                        <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0z"/>
                        <path d="M14.5 3a1 1 0 0 1-1 1H12v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H14a1 1 0 0 1 1 1v1zm-13 0V2a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 .5.5v1h-12z"/>
                    </svg>
                </button>
                <span class="selected-badge" style="display:none;">Selected</span>
            </div>
