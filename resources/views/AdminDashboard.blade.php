                                    ...
                                    <div class="mb-3 col-12 col-md-6">
                                        ...
                                        <div class="mt-3 container">
                                            <div class="mb-3 drop-zone upload-container" id="dropZone2">
                                                ...
                                                <p class="mb-0">Drop video here</p><small class="text-muted">Files Supported: MP4, MOV, WEBM&nbsp;</small><br><label class="btn-upload" for="videoInput">Choose File</label><br><small class="text-muted">Maximum size: 100MB</small><input type="file" id="videoInput" class="video-input" accept="video/*">
                                            </div>
